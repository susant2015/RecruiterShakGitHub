...
@implementation ModelLogInApplicant
...
-(id)initWithDictionary:(NSDictionary *)dict
{
    ...
    if (self = [super init]) {
        ...
        if ([dict objectForKey:@"skills"]&&![[dict objectForKey:@"skills"] isKindOfClass:[NSNull class]]) {
            self.strSkill =[dict objectForKey:@"skills"];
        }else{
            self.strSkill =@"";
        }
