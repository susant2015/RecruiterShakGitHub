...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0) {
        ...
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strFirst_Name attributes:@{NSForegroundColorAttributeName: color}];
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strLast_Name attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==3) {
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strEmail attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==4) {
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strUser_Name attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==5) {
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strPhone_Number attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==9) {
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strCity attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==13) {
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strState attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==14) {
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strCountry attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==15) {
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtFielfPlaceHolderName.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strZip_Code attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==16) {
        ...
        cell.backgroundColor=cell.contentView.backgroundColor=[UIColor clearColor];
        UIColor *color = [UIColor whiteColor];
        cell.txtAboutPlaceholder.attributedPlaceholder = [[NSAttributedString alloc] initWithString:modelLogInApplicant.strAbout attributes:@{NSForegroundColorAttributeName: color}];
        myCell=cell;
    }
    else if(indexPath.row==18) {
